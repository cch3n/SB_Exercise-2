...
#Cabin, filling in missing values could help provide more information regarding passengers. 
#A missing cabin number could mean that the individual was not on the ship ledger. 
#It would still be helpful to note if that is the case. 
